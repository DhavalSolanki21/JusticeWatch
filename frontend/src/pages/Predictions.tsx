...
const Predictions: React.FC = () => {
  ...
  const [predictMode, setPredictMode] = useState<'search' | 'custom'>('custom');
  ...
  const runPrediction = async (payload: any) => {
                ...
                <form onSubmit={handleCustomSubmit}>
                  <div className="grid-2" style={{ gap: '1rem' }}>
                    ...
                    <div className="form-group">
                      ...
                      <input type="number" className="form-control" value={customData.days_since_filing} onChange={(e) => setCustomData({...customData, days_since_filing: parseInt(e.target.value) || 0})} />
                    </div>
                    <div className="form-group">
              ...
              {predictionResult && (
                <div className="animate-fadeInUp">
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    {predictionResult.roadmap.map((phase: any, idx: number) => (
                  ...
                  <div style={{ marginTop: '1.5rem', fontSize: '0.8rem' }}>
                    ...
                    <ul style={{ paddingLeft: '1.5rem', marginTop: '0.5rem', color: 'var(--severity-high)' }}>
                      {predictionResult.predictions.risk_factors.map((f: string, i: number) => <li key={i}>{f}</li>)}
                    </ul>
                  </div>
