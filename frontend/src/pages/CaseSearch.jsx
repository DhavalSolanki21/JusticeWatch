      ...
      <div className="page-wrapper animate-fadeInUp">
        ...
        <div className="page-header">
          <div className="page-header-info">
            ...
            <p className="page-header-meta">
              {isLawyer ? 'Advocate Assigned Litigations' : 'Gujarat State Judicial Records Database'}
            </p>
          </div>
        </div>
        ...
        <div className="jw-card">
          <div className="jw-card-header">
            <div>
              <h2 className="jw-card-title">{isLawyer ? 'My Assigned Cases' : 'Registry Results'}</h2>
