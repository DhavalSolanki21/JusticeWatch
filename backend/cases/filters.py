...
class CaseFilter(filters.FilterSet):
    ...
    district__name = filters.CharFilter(field_name="district__name", lookup_expr='icontains')

    class Meta:
        model = Case
        fields = ['case_category', 'case_status', 'district', 'state', 'crime_type', 'chargesheet_status']
