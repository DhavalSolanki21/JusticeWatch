...
def generate_mock_dataset(size=5000):
    ...
    crime_types = [
        "Theft", "Assault", "Property Dispute", "Financial Fraud", 
        "Murder", "Cheating", "Kidnapping", "Trespass", "Unknown"
    ]
    ...
    data = {
        ...
        'date_of_filing': pd.date_range(start='2010-01-01', end='2018-12-31', periods=size)
    }
...
if __name__ == '__main__':
    ...
    results_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'artifacts', 'RESULTS.md')
